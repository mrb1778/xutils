...
from .expression_evaluator import DictVariableResolver
from .sexpression import SimpleExpressionEvaluator
from ..data.text_utils import camel_to_snake
...
class ExpressionsTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.variable_resolver = DictVariableResolver(self.variables)
